...
WHERE  [reponse_confirmation].[code_retour]='00' and [reponse_confirmation].[dossier] =@dossier and [reponse_confirmation].[dossier] NOT IN(SELECT [dossier] FROM [dbo].[reponse_annulation]   WHERE  [reponse_annulation].[code_retour]='0'
